...
class TestConnectionPool(HTTPDummyServerTestCase):
    ...
    def test_socket_options(self, socket_options) -> None:
    ...
    def test_disable_default_socket_options(self, socket_options) -> None:
    ...
    def test_invalid_method_not_allowed(self, char) -> None:
    ...
    def test_source_address_error(self, invalid_source_address, is_ipv6) -> None:
        with HTTPConnectionPool(
    ...
    def test_user_agent_header_not_sent_twice(self, headers, chunked) -> None:
        with HTTPConnectionPool(self.host, self.port) as pool:
    ...
    @pytest.mark.parametrize("chunked", [True, False])
    def test_skip_header(self, accept_encoding, host, user_agent, chunked) -> None:
        headers = {}
    ...
    @pytest.mark.parametrize("chunked", [True, False])
    def test_skip_header_non_supported(self, header, chunked) -> None:
        with HTTPConnectionPool(self.host, self.port) as pool:
            with pytest.raises(
                ValueError,
    ...
    def test_headers_not_modified_by_request(
        self, chunked, pool_request, header_type
    ) -> None:
    ...
    def test_user_agent_non_ascii_user_agent(self, user_agent) -> None:
        with HTTPConnectionPool(self.host, self.port, retries=False) as pool:
            r = pool.urlopen(
                "GET",
                "/headers",
